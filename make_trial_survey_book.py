...
선점실시 절차는 「GNSS 수신기 → 오버하우저(※ GSM-19T 는 실제로 프로톤 자력계) 자기구배 확인 → 중심점 선정 및 표지
설치」이며 DI-flux 절대관측은 선점이 «끝난 뒤»의 별도 단계다. 따라서 §19①·§20 도
이 야장의 게이트가 아니고, 재는 것은 **프로톤 자력계(GSM-19T) 총자력뿐**이다.
...
def sheet_gate(wb, pts):
    ...
    #    해당하지 않는다. 시험 탐사는 프로톤 자력계 총자력만 재고, 절대관측은 선점이
