...
SVG_GEAR = r'''<svg class="figsvg" viewBox="0 0 1180 530" role="img"
 aria-label="올해 쓰는 GSM-19T 프로톤(양성자) 자력계와 GNSS 수신기, 내년 쓰는 MinGeo 010B DI-flux 자기경위의">
<defs>
...
<g font-family="inherit" text-anchor="middle">
 ...
 <text x="205" y="474" fill="#eaf2f8" font-size="18" font-weight="700">프로톤 자력계</text>
...
<section data-t="장비"><div class="wrap">
 ...
 <div class="grid3 reveal" style="margin-top:24px">
  <div class="card good"><h3 class="hl-g">① 프로톤(양성자) 자력계</h3>
